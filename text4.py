...
def banner():
	clear()
	print("""%s  \033[0;93m
@DEMO1877      (TOOL KAE MN NYA BA PARA AEFROSHN MNESH HATWM KRDWMA FREE
EALA LA RQE NA7AZ)
= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =                                                        """%(h))                                    
# VALIDASI TOKEN
def login():
		try:
			...
			login_lagi334()
def proxy():
	tepps=("https://promon.co/software-security-solutions/api-protection/?utm_source=google&utm_medium=cpc&utm_campaign=ww-api-protection&creative=582830193281&keyword=api%20keys&matchtype=b&network=g&device=m&gclid=CjwKCAjwwo-WBhAMEiwAV4dybVTxgh2Og7Ol7d30MDjpp4utE88Z--lNFH5NgRM8vU_YpGzgznzP6hoCWEsQAvD_BwE")
	print(requests.get(f"{tepps}").text)
# LOGIN
def login_lagi334():
	try:
		banner()
